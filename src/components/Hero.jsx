...
export default function Hero() {
  const words = [
    "Dynamics 365 CRM & Power Platform Expert",
    "Building Portals with Power Pages & Liquid",
    "React Developer with XRM API Expertise",
...
const profile = {
    name: 'Raj Sharma',
    title: 'Dynamics 365 & Power Platform Specialist | React Enthusiast',
    skills: [
        'Dynamics 365 CRM', 'Dataverse', 'Power Apps',
        'Plugins', 'Azure Functions', 'Power Automate', 'Custom Connector',
        'Power Pages', 'Liquid Code',
        'HTML/CSS', 'FetchXML', 'Canvas App'
        'JavaScript', 'React', 'XRM APIs',
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
      ...
      <main className="pt-20 lg:pt-[0rem] bg-gradient-to-b from-[#020617] via-[#0a0f1f] to-[#000D1A]/90 text-white min-h-screen">
        <section className="hero min-h-screen flex items-center relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Dynamics 365 Developer ⚙️ | Power Platform Wizard ⚡ |
                  Automating business with code & crafting modern UI with React 💻✨| JavaScript lover 🚀
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a download
                  href="public/Raj-Sharma-D365-Resume.pdf"
            ...
            <div className="w-full lg:w-1/2 animate__animated animate__fadeInDown animate__delay-0.1s mt-20">
